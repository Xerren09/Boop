...
import { BoopProject, createProjectFile } from "./boop.project.js";
...
class ProjectManager extends EventEmitter implements IAsyncDisposable {
    ...
    public async Load(projectName: string): Promise<BoopProject> {
        return await this.lock.acquire("load", async () => { 
    ...
    public async LoadAll() {
        return await this.lock.acquire("loadAll", async () => { 
    ...
    public async DeployAll() {
        return await this.lock.acquire("deployAll", async () => { 
            const errors: any[] = [];
    ...
    public async StopAll(force: boolean = false) {
        return await this.lock.acquire("stopAll", async () => { 
            const errors: any[] = [];
